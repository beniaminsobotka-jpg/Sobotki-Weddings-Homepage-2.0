        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center relative">
            ...
            <div className="order-2 lg:order-1 flex flex-col items-center relative z-10">
                ...
                <div 
                    ...
                    className="relative h-[260px] md:h-[550px] w-full flex justify-center items-center perspective-1000 cursor-crosshair touch-pan-y"
                    ...
                    {portraits.map((item, index) => {
                        ...
                        return (
                            <motion.div
                                ...
                                className="absolute w-[180px] h-[240px] md:w-[380px] md:h-[480px] origin-center pointer-events-none"
                                initial={false}
                                animate={{
                                    x: style.x,
                                    z: style.z,
                ...
                <div className="mt-0 md:mt-12 w-full max-w-sm relative px-4">
            ...
            <div className="order-1 lg:order-2 flex flex-col items-center lg:items-start text-center lg:text-left relative z-30 pointer-events-none">
                <div className="pointer-events-auto max-w-lg">
                    ...
                    <div className="w-12 h-[1px] bg-white/20 my-4 lg:my-8 lg:mr-auto lg:ml-0 mx-auto"></div>
                    
                    {/* Glass Panel Description */}
                    <div className="p-4 md:p-8 rounded-2xl border border-white/10 bg-white/5 backdrop-blur-md shadow-[0_0_30px_rgba(0,0,0,0.3)] mb-4 lg:mb-10">
