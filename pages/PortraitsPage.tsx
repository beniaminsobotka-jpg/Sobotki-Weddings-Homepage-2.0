                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-x-16 gap-y-12 border-t border-white/10 pt-16">
                        ...
                        <div className="flex gap-6 items-start">
                            ...
                            <div>
                                ...
                                <p className="font-sans text-sm text-gray-400 leading-relaxed">
                                    Przywozimy na salę profesjonalne oświetlenie, białe, podświetlane od środka tło, dodatkową lampę oraz stację drukowania. Potrzebujemy tylko kawałka przestrzeni (ok. 3x3m), by stworzyć warunki jak w studiu fotograficznym.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="flex gap-6 items-start">
                            ...
                            <div>
                                <h3 className="font-serif text-2xl text-white mb-3">Zdjęcia od ręki</h3>
                                <p className="font-sans text-sm text-gray-400 leading-relaxed">
                                    Zdjęcia trafiają na folder Dropbox natychmiast po ich zrobieniu. Goście skanują QR kod z linkiem do folderu i pobierają swoje portrety od razu — bez czekania.
                                </p>
                            </div>
                        </div>
                    </div>
