...
const INTERESTED_OFFERS = new Set([
  ...
  // Zachowujemy starsze wartości dla ofert otwartych przed zmianą cennika.
  'Fotostacja Essential - 2900 zł',
  'Fotostacja Exclusive - 3600 zł',
  'Fotostacja Exclusive - 3900 zł',
  'Fotostacja Essential - 3600 zł',
  'Fotostacja Exclusive - 4300 zł',
  'Fotostacja Essential - 3200 zł',
  'Fotostacja Exclusive - 4200 zł',
  'Fotostacja Essential - 3500 zł',
  'Fotostacja Exclusive - 4500 zł',
  'Fotostacja Essential - 3800 zł',
  'Fotostacja Exclusive - 4800 zł',
  'Filmowe kółko - dodatek',
  'Filmowe kółko - dodatek do Essential',
...
export default async function handler(request, response) {
  ...
  const lead = {
    ...
    distanceKm: Number.isFinite(Number(parsedBody.distanceKm)) ? Number(parsedBody.distanceKm) : 0,
    pricingTier: normalizeString(parsedBody.pricingTier),
    resolvedLocation: normalizeString(parsedBody.resolvedLocation),
